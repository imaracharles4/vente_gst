...
<head>
    ...
    <script type="text/javascript" src="assets/js/scriptpopup.js"></script>
...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            <ul>
                <li>
                    <a href="index.php" class="active"><span class="las la-igloo"></span><span>Acceuil</span></a>
                </li>
                <li>
                    <a href="produit.php"><span class="las la-clipboard-list"></span><span>Produits</span></a>
                </li>
                <li>
                    <a href="blog.php"><span class="las la-receipt"></span><span>Blog</span></a>
                </li>
                <li>
                    <a href="mecanicien.php"><span class="las la-edit"></span><span>Mecaniciens</span></a>
                </li>
                <li>
                    <a href="deconnexion.php"><span class="las la-user-circle"></span><span>Déconnexion</span></a>
                </li>
            </ul>
        </div>        
    </div>
    ...
    <div class="main-content">
           <header>
               <h2>
                   ...
                   Gestion de la boutique <?= $_SESSION['boutique']?>
               </h2>
